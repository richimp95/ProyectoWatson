...
public class MainActivity extends Activity {
    ...
    static String platica=new String() ;
    ...
    public static class FragmentTabSTT extends Fragment implements ISpeechDelegate {
        ...
        public void displayResult(final String result) {
            final Runnable runnableUi = new Runnable(){
                ...
                public void run() {
                    ...
                    platica=textResult.getText().toString();
                }
            };
        ...
        private void empezar() {
            Intent intent = new Intent(getActivity(),RespuestaWatson.class);
            intent.putExtra("platica",platica);
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabSTT = actionBar.newTab().setText("Diagnostico");
